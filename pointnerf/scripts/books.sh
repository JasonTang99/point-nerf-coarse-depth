...
# ranges=" -3.995 -1.473 -3.1 1.613 1.749 1.697 " # scale 10
# ranges=" -1.6 -0.575 -1.24 0.8 0.698 0.684 " # scale 2
# ranges=" -1.172 -0.155 -0.198 -0.002 0.387 0.657 " # scale 2 trans 0
# ranges=" -0.472 -0.155 -0.198 0.698 0.387 0.657 " # trans 0.7
ranges=" -0.409 -0.14 -0.22 1.044 0.396 0.665 "
# SR=80
# SR=32
SR=24
# SR=12
...
shading_feature_mlp_layer3=2 #14.1M
...
random_sample_size=48 #60 #94 #48 # 32 * 32 = 1024
...
maximum_step=300000 #300000 #800000
